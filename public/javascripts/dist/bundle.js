...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util */ "./public/javascripts/util.js");
...
var ProductView = /*#__PURE__*/function () {
  function ProductView(selectors, _ref, vendingModel) {
    var productInfo = _ref.productInfo;
  ...
  _createClass(ProductView, [{
    ...
    value: function init() {
      ...
      this.render();
      this.model.subscribe(function (productData) {
        if (productData.type === 'PURCHASABLE_LIST') _this.addHighlight(productData.value);
      });
      this.addEvent();
    }
  }, {
    ...
    value: function render() {
      this.$.$itemList.innerHTML = this.itemList.reduce(function (acc, _ref2) {
        var name = _ref2.name,
            price = _ref2.price;
    ...
    key: "addHighlight",
    value: function addHighlight(purchasableList) {
      var itemNames = _util__WEBPACK_IMPORTED_MODULE_6__.default.$a('.product__item--name', this.$.$itemList);

      itemNames.forEach(function (e) {
        return _util__WEBPACK_IMPORTED_MODULE_6__.default.cr(e, 'highlighted');
      });
      purchasableList.forEach(function (_ref3) {
        var id = _ref3.id;
        return _util__WEBPACK_IMPORTED_MODULE_6__.default.ca(itemNames[id], 'highlighted');
      });
    }
  }, {
    key: "selectProduct",
    value: function () {
      var _selectProduct = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref4) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(this.isDisabled && target.className !== 'product__item--name highlighted')) {
                  _context.next = 3;
                  break;
                }
              ...
              case 3:
                _util__WEBPACK_IMPORTED_MODULE_6__.default.ca(target, 'selected');

                this.isDisabled = true;
                _context.next = 7;
                return _util__WEBPACK_IMPORTED_MODULE_6__.default.delay(function () {
                  return _this2.model.sell(target.innerHTML);
                }, 2000);

              case 7:
                _util__WEBPACK_IMPORTED_MODULE_6__.default.cr(target, 'selected');
    ...
    value: function addEvent() {
      _util__WEBPACK_IMPORTED_MODULE_6__.default.on(this.$.$itemList, 'click', this.selectProduct.bind(this));
    }
  }]);
...
var ProgressView = /*#__PURE__*/function () {
  ...
  _createClass(ProgressView, [{
    ...
    value: function init() {
      ...
      this.model.subscribe(function (accountData) {
        if (accountData.type === 'ACCOUNT_CHANGE') _this.updateAccount(accountData.value);
      });
      this.model.subscribe(function (logData) {
        if (logData.type === 'INPUT_MONEY') _this.updateLog("".concat(logData.value, "\uC6D0\uC774 \uD22C\uC785\uB418\uC5C8\uC2B5\uB2C8\uB2E4."));
        if (logData.type === 'SELL') _this.updateLog("".concat(logData.value, "\uAC00 \uD314\uB838\uC2B5\uB2C8\uB2E4."));
        if (logData.type === 'RETURN_MONEY') _this.updateLog("".concat(logData.value, "\uC6D0\uB9CC\uD07C \uBC18\uD658\uB418\uC5C8\uC2B5\uB2C8\uB2E4."));
      });
      this.addEvent();
    }
  }, {
    key: "addEvent",
    value: function addEvent() {
      _util__WEBPACK_IMPORTED_MODULE_0__.default.on(this.$.$returnButton, 'click', this.model.returnMoney.bind(this.model));
    }
  }, {
    key: "updateAccount",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProgressView);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./util */ "./public/javascripts/util.js");
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./observable */ "./public/javascripts/observable.js");
...
var VendingModel = /*#__PURE__*/function (_Observable) {
  ...
  function VendingModel(data, walletModel) {
    ...
    _this.itemList = data.productInfo;
    _this.account = 0;
  ...
  _createClass(VendingModel, [{
    ...
    value: function sell(itemName) {
      var targetItem = this.itemList.find(function (_ref) {
        var name = _ref.name;
  ...
  return VendingModel;
}(_observable__WEBPACK_IMPORTED_MODULE_13__.default);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VendingModel);
...
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./observable */ "./public/javascripts/observable.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var WalletModel = /*#__PURE__*/function (_Observable) {
  ...
  _createClass(WalletModel, [{
    key: "setAccount",
    value: function setAccount(money) {
      this.wallet.account = money;
      this.distributeAccount();
      this.notify(this.wallet);
    }
  }, {
    key: "distributeAccount",
    value: function distributeAccount() {
      var amount = this.wallet.account;
      this.wallet.currencyUnits.forEach(function (_ref) {
        var currencyUnit = _ref.currencyUnit,
            count = _ref.count;
  ...
  return WalletModel;
}(_observable__WEBPACK_IMPORTED_MODULE_10__.default);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WalletModel);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util */ "./public/javascripts/util.js");
...
var WalletView = /*#__PURE__*/function () {
  ...
  _createClass(WalletView, [{
    ...
    key: "addEvent",
    value: function addEvent() {
      var $currencyUnits = _util__WEBPACK_IMPORTED_MODULE_4__.default.$('.wallet__currency-unit');

      var $walletInput = _util__WEBPACK_IMPORTED_MODULE_4__.default.$('.wallet__total input');

      _util__WEBPACK_IMPORTED_MODULE_4__.default.on($currencyUnits, 'click', this.clickMoney.bind(this));

      _util__WEBPACK_IMPORTED_MODULE_4__.default.on($walletInput, 'keyup', _util__WEBPACK_IMPORTED_MODULE_4__.default.debounce(this.inputMoney.bind(this), 1000));
    }
  }, {
    key: "makeWalletHTML",
    value: function makeWalletHTML() {
      var currencyUnits = [10, 50, 100, 500, 1000, 5000, 10000];
      return "<ul class=\"wallet__currency-unit\"> \n                ".concat(this.makeUnitHTML(currencyUnits), " \n              </ul>\n              <ul class=\"wallet__total__wrapper\">\n                <li class=\"wallet__total\"><input type=\"text\"><span>\uC6D0</span></li>\n              </ul>");
    }
  }, {
    key: "makeUnitHTML",
    value: function makeUnitHTML(unitList) {
      var template = function template(acc, unit) {
        return acc + "<li class=\"currency-unit__".concat(unit, "\">\n        <div>").concat(unit, "<span>\uC6D0</span></div>\n        <div class=\"currency-unit__count\">0<span>\uAC1C</span></div>\n      </li>");
      };
    ...
    key: "updateWallet",
    value: function updateWallet(_ref) {
      var currencyUnits = _ref.currencyUnits,
    ...
    key: "updateUnit",
    value: function updateUnit(units) {
      units.forEach(function (v) {
        return _util__WEBPACK_IMPORTED_MODULE_4__.default.$(".currency-unit__".concat(v.currencyUnit, " .currency-unit__count")).innerHTML = "".concat(v.count, "\uAC1C");
      });
    }
  }, {
    key: "updateAccount",
    value: function updateAccount(account) {
      _util__WEBPACK_IMPORTED_MODULE_4__.default.$('.wallet__total input').value = account;
    }
  }, {
    key: "clickMoney",
    value: function clickMoney(_ref2) {
    ...
    value: function inputMoney() {
      this.walletModel.setAccount(_util__WEBPACK_IMPORTED_MODULE_4__.default.$('.wallet__total input').value);
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WalletView);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./public/javascripts/util.js");
/* harmony import */ var _vendingModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendingModel */ "./public/javascripts/vendingModel.js");
/* harmony import */ var _productView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./productView */ "./public/javascripts/productView.js");
/* harmony import */ var _walletModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./walletModel */ "./public/javascripts/walletModel.js");
/* harmony import */ var _walletView__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./walletView */ "./public/javascripts/walletView.js");
/* harmony import */ var _progressView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./progressView */ "./public/javascripts/progressView.js");
